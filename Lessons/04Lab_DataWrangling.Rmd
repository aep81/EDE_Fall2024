...
NTL.phys.data.1999 <- filter(NTL.phys.data, year(sampledate) == 1999)
...
NTL.phys.data.9099 <- filter(NTL.phys.data.Tuesday, year4 %in% c(1990:1999))
```
...
NTL.phys.data.July <- filter(NTL.phys.data.9099, month %in% c(July))
